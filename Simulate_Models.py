if __name__ == "__main__":
    ...
    #     CDS_simul = CDS_simul_actual #+ R Just assume unknown noise
    #     # Test of value:
    ...
    #             'Filipovic': df_main.loc[i, 'Filipovic'],
    #             'True': df_main.loc[i, 'True'],
    #             'Abs Error, Kalman': df_main.loc[i, 'Abs Error, Kalman'],
    #             'Rel Error (%), Kalman': df_main.loc[i, 'Rel Error (%), Kalman'],
    #             'Abs Error, Filipovic': df_main.loc[i, 'Abs Error, Filipovic'],
    #             'Rel Error (%), Filipovic': df_main.loc[i, 'Rel Error (%), Filipovic']
    #         })
    #         # SE row
    #         rows_with_se.append({
