...
class LHC_single():
    ...
    def test_constriants(self):
        ...
        if failed_idx.size > 0:
            ...
            None #print("All constraints satisfied.")
    ...
    def optimal_parameter_set(self, t_obs,T_M_grid, CDS_obs, penalty=0):
        base_seed = 1000
        n_restarts = 20
        ...
        for i in range(n_restarts):
            ...
            self.test_constriants()
            if self.objective_result < current_objective:
                print(f"New optimal parameters at iteration {i}.")
